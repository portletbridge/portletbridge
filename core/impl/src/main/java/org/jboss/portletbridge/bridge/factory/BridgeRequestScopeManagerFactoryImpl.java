...
public class BridgeRequestScopeManagerFactoryImpl extends BridgeRequestScopeManagerFactory {
    ...
    /**
     * @see org.jboss.portletbridge.bridge.factory.BridgeRequestScopeManagerFactory#getBridgeRequestScopeManager(org.jboss.portletbridge.bridge.config.BridgeConfig)
     */
    @Override
    public BridgeRequestScopeManager getBridgeRequestScopeManager(BridgeConfig bridgeConfig) throws FacesException {
        return new BridgeRequestScopeManagerImpl(bridgeConfig);
    }
