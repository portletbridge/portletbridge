...
/**
 * Utility class designed to make it easy for Faces subsystems including the bridge itself to determine whether this request is
 * running in a portlet container and/or which portlet request phase it is executing in.
 * 
 * @author asmirnov
 * 
 */
public class BridgeUtil {
    ...
    /**
     * Indicates whether the current request is executing in the portlet container. If it returns <code>true</code> the request
     * is a portlet request, otherwise it is not.
     */
    ...
    /**
     * Return describes the portlet request phase currently being executed. If <code>null</code> then this request is not being
     * executed in a portlet container.
     */
