 ...
 * must then only reference such configuation information from this object. I.e. it no longer makes reference to the
 * <CODE>PortletContext</CODE> attributes. This allows replacable pieces of the bridge implementation to always have a
...
public interface BridgeConfig {
     ...
     * <code>PortletMode</code> supported by the portlet (and handledby Faces). The key to the each entry in the map is the
     ...
     * allows differeing portlets in the app to use different render kits.
     * 
