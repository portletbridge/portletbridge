...
/**
 * Faces <code>SystemEvent</code> sent by the Bridge in its <code>doFacesRequest()</code> method after executing the
 * request and before releasing the <code>FacesContext</code>.
 */
