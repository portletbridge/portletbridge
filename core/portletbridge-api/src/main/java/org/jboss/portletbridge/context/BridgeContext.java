...
public abstract class BridgeContext 
{
   ...
   * request scope should be preserved.  <code>false</code> means the request scope should not be preserved.
   ...
   *         <code>true</code> means the request scope should be preserved.  <code>false</code> means
