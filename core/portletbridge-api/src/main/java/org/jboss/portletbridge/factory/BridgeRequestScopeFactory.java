...
public abstract class BridgeRequestScopeFactory extends BridgeFactory<BridgeRequestScopeFactory> {
    ...
    public abstract BridgeRequestScope getBridgeRequestScope(String portletId, String sessionId, String viewId,
    ...
    public abstract BridgeRequestScope getBridgeRequestScope(String portletId, String sessionId, String viewId,
            String portletMode, Map<String, Object> t) throws FacesException;
