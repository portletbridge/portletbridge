...
public abstract class AbstractExternalContext extends ExternalContext {
	...
	public void addResponseCookie(String name, String value,
		...
		// TODO - use PortletResponse instead.
		...
		if (properties != null && properties.size() != 0) {
			for (Map.Entry<String, Object> entry : properties.entrySet()) {
				...
				ALLOWABLE_COOKIE_PROPERTIES p = ALLOWABLE_COOKIE_PROPERTIES
				        .valueOf(key);
	...
	public Flash getFlash() {
		return (Flash) getContextAttribute(PortletFlash.ATTRIBUTE_NAME);
	}
