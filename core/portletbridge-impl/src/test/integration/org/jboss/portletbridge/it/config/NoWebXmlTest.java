...
@PortalTest
public class NoWebXmlTest extends AbstractPortletTest {

    @Deployment
    public static PortletArchive createDeployment() {
        TestDeployment deployment = new TestDeployment(NoWebXmlTest.class, false);
        deployment.archive()
                .createFacesPortlet("NoWebXml", "No WebXml Portlet", "header.xhtml")
