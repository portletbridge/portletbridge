...
public class CustomRenderServiceImpl extends RenderConfigServiceImpl {
	...
	public void init(ServletContext context)
		...
		if (PlutoServices.getServices() != null) {
			...
			PortletContextService contextService = PlutoServices.getServices()
					.getPortletContextService();
			Iterator<DriverPortletContext> portletContexts = contextService
					.getPortletContexts();
			String contextPath = context.getContextPath();
			while (portletContexts.hasNext()) {
				DriverPortletContext driverPortletContext = portletContexts
						.next();
				List<? extends PortletDefinition> portlets = driverPortletContext
