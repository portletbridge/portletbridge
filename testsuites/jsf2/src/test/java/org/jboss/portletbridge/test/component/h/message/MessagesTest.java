...
public class MessagesTest {
    ...
    public void renderFacesPortlet(@Drone WebDriver driver) throws Exception {
        ...
        assertTrue("Messages should be empty at begin.", driver.findElement(MESSAGES_FIELD).getText().equals(""));
        assertTrue("MESSAGE ONE should be empty at begin.", driver.findElement(MESSAGE_ONE_FIELD).getText().equals(""));
        assertTrue("Message Two should be empty at begin.", driver.findElement(MESSAGE_TWO_FIELD).getText().equals(""));
        ...
        assertTrue("MESSAGES should show SUMMARY error message: " + MessagesBean.ONE_ERROR_SUMMARY, ExpectedConditions
                .textToBePresentInElement(MESSAGES_FIELD, MessagesBean.ONE_ERROR_SUMMARY).apply(driver));
        assertTrue("MESSAGES should show SUMMARY error message: " + MessagesBean.TWO_ERROR_SUMMARY, ExpectedConditions
                .textToBePresentInElement(MESSAGES_FIELD, MessagesBean.TWO_ERROR_SUMMARY).apply(driver));

        // Check individual message for each
        assertTrue("MESSAGE ONE should show DETAIL error message: " + MessagesBean.ONE_ERROR_DETAIL, ExpectedConditions
                .textToBePresentInElement(MESSAGE_ONE_FIELD, MessagesBean.ONE_ERROR_DETAIL).apply(driver));
        assertTrue("MESSAGE TWO should show DETAIL error message: " + MessagesBean.TWO_ERROR_DETAIL, ExpectedConditions
                .textToBePresentInElement(MESSAGE_TWO_FIELD, MessagesBean.TWO_ERROR_DETAIL).apply(driver));
        ...
        assertFalse("MESSAGES should NOT show SUMMARY error message: " + MessagesBean.ONE_ERROR_SUMMARY, ExpectedConditions
                .textToBePresentInElement(MESSAGES_FIELD, MessagesBean.ONE_ERROR_SUMMARY).apply(driver));
        assertTrue("MESSAGES should show SUMMARY error message: " + MessagesBean.TWO_ERROR_SUMMARY, ExpectedConditions
                .textToBePresentInElement(MESSAGES_FIELD, MessagesBean.TWO_ERROR_SUMMARY).apply(driver));

        // Check individual message for each
        assertTrue("MESSAGE ONE should show DETAIL message: " + MessagesBean.ONE_OK_DETAIL, ExpectedConditions
                .textToBePresentInElement(MESSAGE_ONE_FIELD, MessagesBean.ONE_OK_DETAIL).apply(driver));
        assertTrue("MESSAGE TWO should show DETAIL error message: " + MessagesBean.TWO_ERROR_DETAIL, ExpectedConditions
                .textToBePresentInElement(MESSAGE_TWO_FIELD, MessagesBean.TWO_ERROR_DETAIL).apply(driver));
        ...
        // Check that h:messages contains correct messages
        assertTrue("Messages should show OK message: " + MessagesBean.ONE_OK_SUMMARY, ExpectedConditions
                .textToBePresentInElement(MESSAGES_FIELD, MessagesBean.ONE_OK_SUMMARY).apply(driver));
        assertTrue("Messages should show OK message: " + MessagesBean.TWO_OK_SUMMARY, ExpectedConditions
                .textToBePresentInElement(MESSAGES_FIELD, MessagesBean.TWO_OK_SUMMARY).apply(driver));

        // Check individual message for each
        assertTrue("MESSAGE ONE should show DETAIL message: " + MessagesBean.ONE_OK_DETAIL, ExpectedConditions
                .textToBePresentInElement(MESSAGE_ONE_FIELD, MessagesBean.ONE_OK_DETAIL).apply(driver));
        assertTrue("MESSAGE TWO should show DETAIL message: " + MessagesBean.TWO_OK_DETAIL, ExpectedConditions
                .textToBePresentInElement(MESSAGE_TWO_FIELD, MessagesBean.TWO_OK_DETAIL).apply(driver));
        ...
        assertEquals("Messages should be empty at end.", driver.findElement(MESSAGES_FIELD).getText(), "");

        // Individual message should be empty as well
        assertEquals("MESSAGE ONE should be empty at end.", driver.findElement(MESSAGE_ONE_FIELD).getText(), "");
        assertEquals("Message Two should be empty at end.", driver.findElement(MESSAGE_TWO_FIELD).getText(), "");
    }
    ...
    public void testMessageShowDetail(@Drone WebDriver driver) throws Exception {
        ...
        assertEquals("MESSAGE ONE should not be rendered as showDetail and showSummary are false", "",
                driver.findElement(MESSAGE_ONE_FIELD).getText());

        assertEquals("MESSAGES should be rendered with SUMMARY message: " + MessagesBean.ONE_OK_SUMMARY + "\r\nSOURCE:\r\n"
                + driver.getPageSource(), MessagesBean.ONE_OK_SUMMARY, driver.findElement(MESSAGES_FIELD).getText());
    }
    ...
    public void testMessageShowSummary(@Drone WebDriver driver) throws Exception {
        ...
        assertTrue("MESSAGE ONE should show SUMMARY message: " + MessagesBean.ONE_OK_SUMMARY, ExpectedConditions
                .textToBePresentInElement(MESSAGE_ONE_FIELD, MessagesBean.ONE_OK_SUMMARY).apply(driver));
        ...
        assertFalse("MESSAGE ONE should NOT show DETAIL message: " + MessagesBean.ONE_OK_DETAIL, ExpectedConditions
                .textToBePresentInElement(MESSAGE_ONE_FIELD, MessagesBean.ONE_OK_DETAIL).apply(driver));
    ...
    public void testMessagesRendered(@Drone WebDriver driver) throws Exception {
        ...
        assertEquals("MESSAGES should be rendered with message: " + MessagesBean.ONE_OK_SUMMARY, MessagesBean.ONE_OK_SUMMARY,
    ...
    public void testMessagesShowDetail(@Drone WebDriver driver) throws Exception {
        ...
        assertTrue("MESSAGES should show DETAIL message: " + MessagesBean.ONE_OK_DETAIL, ExpectedConditions
                .textToBePresentInElement(MESSAGES_FIELD, MessagesBean.ONE_OK_DETAIL).apply(driver));

        assertTrue("MESSAGES should show SUMMARY message: " + MessagesBean.ONE_OK_SUMMARY, ExpectedConditions
                .textToBePresentInElement(MESSAGES_FIELD, MessagesBean.ONE_OK_SUMMARY).apply(driver));
    ...
    public void testMessagesShowSummary(@Drone WebDriver driver) throws Exception {
        ...
        assertEquals("MESSAGES should NOT be rendered as showDetail and showSummary are false", "",
                driver.findElement(MESSAGES_FIELD).getText());
    }
    ...
    public void testMessagesGlobalOnly(@Drone WebDriver driver) throws Exception {
        ...
        assertTrue("MESSAGES should show SUMMARY message: " + MessagesBean.TWO_OK_SUMMARY, ExpectedConditions
                .textToBePresentInElement(MESSAGES_FIELD, MessagesBean.TWO_OK_SUMMARY).apply(driver));

        assertTrue("MESSAGES should show GLOBAL SUMMARY message: " + MessagesBean.GLOBAL_SUMMARY, ExpectedConditions
                .textToBePresentInElement(MESSAGES_FIELD, MessagesBean.GLOBAL_SUMMARY).apply(driver));

        assertFalse("MESSAGES should NOT show GLOBAL DETAIL message: " + MessagesBean.GLOBAL_DETAIL, ExpectedConditions
                .textToBePresentInElement(MESSAGES_FIELD, MessagesBean.GLOBAL_DETAIL).apply(driver));
        ...
        assertFalse("MESSAGES should NOT show SUMMARY message: " + MessagesBean.TWO_OK_SUMMARY, ExpectedConditions
                .textToBePresentInElement(MESSAGES_FIELD, MessagesBean.TWO_OK_SUMMARY).apply(driver));
        ...
        assertTrue("MESSAGES should show GLOBAL DETAIL message: " + MessagesBean.GLOBAL_DETAIL, ExpectedConditions
                .textToBePresentInElement(MESSAGES_FIELD, MessagesBean.GLOBAL_DETAIL).apply(driver));
    }
}
