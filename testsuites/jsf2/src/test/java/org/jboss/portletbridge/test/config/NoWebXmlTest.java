...
@PortalTest
public class NoWebXmlTest {

    @Deployment
    public static WebArchive createNoWebXmlDeployment() {
        return TestDeployment.createDeploymentWithFacesConfig()
                .addAsWebInfResource(new StringAsset(TestDeployment.createPortletXmlDescriptor("noWebXml").exportAsString()), "portlet.xml")
    ...
    @Test
    @RunAsClient
    public void noWebXml() throws Exception {
